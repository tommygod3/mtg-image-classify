...
class ArtCNN:
    ...
    def __init__(self, dataset_dir, model_filename, batch_size = 128, num_epochs = 5, img_height = 150, img_width = 150, color_bands = 3):
...
print("Color: ")
ArtCNN(dataset_dir="../download/art/color", model_filename="color_model.h5")
print("Type: ")
ArtCNN(dataset_dir="../download/art/type", model_filename="type_model.h5")
